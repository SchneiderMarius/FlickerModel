...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 SinClamp /mnt/hpc/home/schneiderm/Projects/12B_Neuron/CellModels/472451419/modfiles/SinClamp.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ...
   if ( t < del ) {
     ...
     if ( t < del + dur ) {
       i = 0.5 * pkamp * sin ( 2.0 * PI * freq * ( t - del ) / 1000.0 + phase ) + 0.5 * pkamp ;
       }
     else {
       i = 0.0 ;
       }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/hpc/home/schneiderm/Projects/12B_Neuron/CellModels/472451419/modfiles/SinClamp.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  "	}else{  \n"
  "            if (t < del+dur) {\n"
  "	        i = 0.5*pkamp*sin(2*PI*freq*(t-del)/1000+phase)+0.5*pkamp\n"
  "	   }else{  \n"
  "	        i = 0\n"
  "}}}\n"
  ;
